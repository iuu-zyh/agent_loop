...
> 附录全文。**字母编号沿用原稿**——正文与其它文档里的「附录 A / B / D / E / G」引用继续有效。
> 原 F（Unity 中文界面术语）已并入本文 E.5。
...
| 游戏内 UI 源码 | `csharp/UI/`（三面板与剧情窗注入源码） |
